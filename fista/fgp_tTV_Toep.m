function est = fgp_tTV_Toep(xfm, T, samp, lambda, maxIter, tol)
%
%   est = fgp_tTV(xfm, T, samp, lambda, [maxIter], [tol])
%
%   fgp_tTV 
...
while iter <= maxIter && update > tol
    ...
    est     =   denoise(y - (2/L)*(mtimes_Toeplitz(xfm,T,y) - samp), 2*lambda/L, tv_iters, tv_tol);
